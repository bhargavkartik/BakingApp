...
/**
 * Created by kbhargav on 27-03-2018.
 */
...
public class RecipeIngredientStepAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecipeIngredientStepAdapter(Context context, StepItemClickIinterface stepItemClickIinterface, Recipe recipe) {
        mContext = context;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == INGREDIENT) {
            ...
            return new RecipeIngredientStepAdapter.IngredientViewHolder(view);
        } else {
            View view = LayoutInflater.from(mContext).inflate(R.layout.recipe_step, parent, false);
            return new RecipeIngredientStepAdapter.StepViewHolder(view);
        }
    }
